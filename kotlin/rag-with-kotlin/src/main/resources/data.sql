...
INSERT INTO dog (id, name, description, dob, owner, gender, image) VALUES
    (95, 'Mia', 'A grey Great Dane known for being loyal.', '2020-11-03', NULL, 'f', 'https://raw.githubusercontent.com/joshlong-attic/dog-images/main/great-dane-2.png');

INSERT INTO dog (id, name, description, dob, owner, gender, image) VALUES
    (71, 'Molly', 'A golden Chihuahua known for being curious.', '2014-03-22', NULL, 'f', 'https://raw.githubusercontent.com/joshlong-attic/dog-images/main/chihuahua-2.png');

INSERT INTO dog (id, name, description, dob, owner, gender, image) VALUES
    (65, 'Ruby', 'A white Great Dane known for being protective.', '2021-11-07', NULL, 'f', 'https://raw.githubusercontent.com/joshlong-attic/dog-images/main/great-dane-3.png');
