 ...
 * Generated by scaffold_integration_test.py on 2025-08-01 11:50:52
 */
...
public class RunStarterDefaultClient {
    ...
    public static void main(String... args) throws Exception {
        ...
        try {
            ...
            out.println("🏗️  Building starter-default-client...");
            ...
            out.println("🚀 Running starter-default-client...");
            // Create persistent log file for debugging
            Path logDir = Paths.get("../../../integration-testing/logs/integration-tests");
            Files.createDirectories(logDir);
            Path logFile = logDir.resolve("starter-default-client-spring-boot-" + System.currentTimeMillis() + ".log");
