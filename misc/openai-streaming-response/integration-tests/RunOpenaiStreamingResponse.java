...
public class RunOpenaiStreamingResponse {
    ...
    public static void main(String... args) throws Exception {
        ...
        try {
            ...
            out.println("🏗️  Building openai-streaming-response...");
            ...
            out.println("⏳ Waiting for server to start...");
            int port = 8080;
            waitForServerReady(port, 60);
            
            // Test the streaming endpoint
            out.println("🧪 Testing streaming endpoint...");
            String response = testStreamingEndpoint(port);
            
            // Verify response patterns
            out.println("✅ Verifying response patterns...");
    ...
    private static void waitForServerReady(int port, int timeoutSec) throws Exception {
        ...
        while (System.currentTimeMillis() - start < timeout) {
            try (Socket socket = new Socket()) {
                ...
                out.println("✅ Server is ready on port " + port);
                return;
            } catch (Exception e) {
                Thread.sleep(1000);
            }
        ...
        try (CloseableHttpClient client = HttpClients.createDefault()) {
            ...
            return client.execute(request, response -> {
                ...
                if (status >= 200 && status < 300) {
                    ...
                    out.println("📡 Received streaming response (" + body.length() + " chars)");
                    return body;
                } else {
