...
/*
 * Integration test launcher for evaluator-optimizer
 * Generated by scaffold_integration_test.py on 2025-07-31 18:03:32
 */
...
public class RunEvaluatorOptimizer {
    ...
    public static void main(String... args) throws Exception {
        ...
        try {
            ...
            out.println("🏗️  Building evaluator-optimizer...");
            ...
            for (int i = 0; i < lines.length; i++) {
                ...
                if (trimmed.contains("=== GENERATOR OUTPUT ===") || 
                    trimmed.contains("=== EVALUATOR OUTPUT ===") || 
                    trimmed.contains("EVALUATION:") || 
                    trimmed.contains("FINAL OUTPUT:") ||
                    trimmed.contains("THOUGHTS:") ||
